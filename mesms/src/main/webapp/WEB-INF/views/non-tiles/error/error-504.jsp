...
<html lang="en">
    <head>
        ...
        <title>504 Error - Maeil Everyday</title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="text-center mt-4">
                                    <img class="img-fluid p-4" src="${contextPath }/resources/bootstrap/assets/img/illustrations/504-error-gateway-timeout.svg" alt="" />
