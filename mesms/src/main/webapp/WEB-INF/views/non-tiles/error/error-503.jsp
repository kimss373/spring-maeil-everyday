...
<html lang="en">
    <head>
        ...
        <title>503 Error - Maeil Everyday</title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="text-center mt-4">
                                    <img class="img-fluid p-4" src="${contextPath }/resources/bootstrap/assets/img/illustrations/503-error-service-unavailable.svg" alt="" />
                                    ...
                                    <a class="text-arrow-icon" href="${contextPath }/main">
