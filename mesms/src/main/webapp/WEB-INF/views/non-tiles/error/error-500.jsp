...
<html lang="en">
    <head>
        ...
        <title>500 Error - Maeil Everyday</title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="text-center mt-4">
                                    <img class="img-fluid p-4" src="${contextPath }/resources/bootstrap/assets/img/illustrations/500-internal-server-error.svg" alt="" />
