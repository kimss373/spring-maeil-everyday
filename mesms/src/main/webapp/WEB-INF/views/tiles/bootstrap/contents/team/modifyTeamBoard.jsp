            ...
            <div class="page-header-content pt-4">
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto mt-4">
                        ...
                        <div class="page-header-subtitle">수정</div>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="sbp-preview">
                                <div class="sbp-preview-content">
                                    <form action="/team/modifyTeamBoard" method="post">
                                        <div class="form-group">
                                            <label for="exampleFormControlInput1">제목</label>
                                            <input class="form-control" name="title" id="exampleFormControlInput1" type="text" value="${teamBoardDTO.title }" />
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleFormControlTextarea1">내용</label>
                                            <textarea class="form-control" name="content" id="exampleFormControlTextarea1" rows="3" >${teamBoardDTO.content }</textarea>
