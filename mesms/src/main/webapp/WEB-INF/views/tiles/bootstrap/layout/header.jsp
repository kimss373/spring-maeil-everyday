...
<body>
	<nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white" id="sidenavAccordion">
            ...
            <a class="navbar-brand" href="${contextPath }/main">Maeil Everyday</a>
            ...
            <ul class="navbar-nav align-items-center ml-auto">
                ...
                <li class="nav-item dropdown no-caret mr-3 mr-lg-0 dropdown-user">
                    <a class="btn btn-icon btn-transparent-dark dropdown-toggle" id="navbarDropdownUserImage" href="javascript:void(0);" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img class="img-fluid" src="${contextPath }/thumbnails?profileImage=${sessionScope.profileImage }" /></a>
                    <div class="dropdown-menu dropdown-menu-right border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownUserImage">
                        <h6 class="dropdown-header d-flex align-items-center">
                            <img class="dropdown-user-img" src="${contextPath }/thumbnails?profileImage=${sessionScope.profileImage }" />
                            <div class="dropdown-user-details">
                                <div class="dropdown-user-details-name">${sessionScope.memberNm }</div>
                                <div class="dropdown-user-details-email">${sessionScope.memberId }</div>
                            </div>
                        </h6>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="${contextPath }/member/myInfo">
